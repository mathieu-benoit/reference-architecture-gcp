...
module "res_defs" {
  ...
  k8s_project_number              = var.project_number
  ...
  terraform_provisioner_gsa_email = module.k8s.terraform_provisioner_gsa_email
  gcp_wi_pool_provider_name       = module.k8s.gcp_wi_pool_provider_name
}
